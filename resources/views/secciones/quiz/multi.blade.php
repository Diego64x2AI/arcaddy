...
@foreach ($pregunta->respuestas as $respuesta)
	<div>
		...
		<label for="respuesta-{{ $respuesta->id }}"><input type="text" name="respuesta-{{ $pregunta->id }}-otra" placeholder="{{ $respuesta->respuesta }}" class="border py-2 text-sm border-gray-300 w-3/4 color"></label>
		@else
