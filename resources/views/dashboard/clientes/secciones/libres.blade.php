<div id="libres" class="bg-white p-3 mt-3">
	...
	<div class="flex flex-row items-center font-bold">
		<div class="text-xl md:text-3xl truncate mr-1">Banners Libres</div>
		<div class="ml-auto"><span class="hidden md:inline-block">Activar / Desactivar </span><input type="checkbox" name="libres-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'libres')->first()->activa) checked @endif></div>
