					...
					<div class="p-6 bg-gray-100 border border-white">
						...
						<div id="secciones-container">
							...
							<div id="colaboradores" class="bg-white p-3 mt-3">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Colaboradores / Artistas / Invitados / Responsables</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="colaboradores-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'colaboradores')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
							...
							<div id="patrocinadores" class="bg-white p-3 mt-3">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Patrocinadores:</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="patrocinadores-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'patrocinadores')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
							...
							<!-- /patrocinadores -->
							<div id="blog" class="bg-white p-3 mt-3">
								<input type="hidden" name="secciones[]" value="blog">
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Blog / Lifestyle</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="blog-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'blog')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
								...
								<div class="text-right mt-5">
									<a href="" id="add_blog" class="btn-pill">+ Agregar</a>
								</div>
							</div>
							<!-- /blog -->
							<div id="galeria" class="bg-white p-3 mt-3">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Galería:</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="galeria-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'galeria')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
							...
							<div id="playlist" class="bg-white p-3 mt-3">
								...
								<div class="text-right mt-5">
									<a href="" id="add_playlist" class="btn-pill">+ Agregar</a>
								</div>
							</div>
							<!-- /playlist -->
							<div id="experiencia" class="bg-white p-3 mt-3">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Experiencia inversiva link</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="experiencia-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'experiencia')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
							...
							<div id="live" class="bg-white p-3 mt-3 section-box">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Live Link</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="live-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'live')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
								<div class="mt-5">
							...
							<div id="social" class="bg-white p-3 mt-3 section-box">
								...
								<div class="flex flex-row items-center font-bold">
									<div class="text-3xl">Social Media</div>
									<div class="ml-auto">Activar / Desactivar <input type="checkbox" name="social-activo" value="on" @if($cliente->id !== NULL && $cliente->secciones()->where('seccion', 'social')->first()->activa) checked @endif></div>
									<div class="ml-5 cursor-move handler2">Mover <i class="fas fa-ellipsis-v"></i></div>
								</div>
								<div class="flex flex-wrap items-center -mx-3 mt-5">
									<div class="w-full md:w-1/3 px-3 mb-6 md:mb-2">
