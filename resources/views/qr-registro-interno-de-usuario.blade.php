...
<body class="font-sans antialiased">
	<main class="px-5 pb-20">
		...
		<div class="text-center font-semibold w-full sm:max-w-md mx-auto">{{ $user->name }}</div>
		<div class="text-center font-semibold w-full sm:max-w-md mx-auto">{{ $user->email }}</div>
		...
		<div class="my-5 text-center w-full sm:max-w-md mx-auto">
			<a href="{{route('my-app-client.reporte-base-usuarios')}}" class="btn btn-pill font-bold">Ir al listado</a>
		</div>
