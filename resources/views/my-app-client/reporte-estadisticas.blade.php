...
@section('content')
		...
		<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
			<div class="flex flex-row items-center w-full">
				<div class="grow max-w-[90%] flex flex-row items-center">
					<div
						class="bg-gray-50 flex flex-row items-center p-5 w-full shadow-lg max-w-md rounded-tr-3xl rounded-br-3xl border border-gray-100">
	...
	<div class="bg-[#262626] w-full py-5 text-white">
		<div class="flex flex-row items-center justify-center">
			<div class="">
				<img src="{{ asset('images-my-app/btn-estadisticas.png') }}" alt="Estadisticas Generales"
					class="w-auto h-14">
			</div>
							...
							<div class="bg-white w-full p-5 border border-white rounded-3xl mt-5 lg:mt-10">
								...
								<div class="grid grid-cols-3">
									@foreach ($marcos as $galeria)
										<div>
											<img src="{{ asset('storage/' . $galeria->archivo) }}" alt="{{ $galeria->titulo }}"
												class="w-full h-auto">
										</div>
									@endforeach
								</div>
