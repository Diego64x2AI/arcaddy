...
class ClienteEstadisticas extends Controller
{
	...
	public function index(Cliente $cliente, Request $request)
	{
		...
		return view('dashboard.estadisticas.index', compact('cliente', 'quiz', 'beneficios', 'canjes', 'quiz_totales', 'top_users', 'quiz_respuestas', 'totales', 'games', 'visitas', 'qrlinks', 'realidades', 'sucursales', 'marcos', 'marcos_compartidos', 'marcos_subidos'));
	}
}
